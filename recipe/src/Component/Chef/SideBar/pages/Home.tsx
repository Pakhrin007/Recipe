...
const Home = () => {
    ...
    return (
        <div className="flex flex-col gap-y-[20px] px-[20px] py-[20px] w-full">
            <h1 className="text-[24px] font-bold text-[#BE1E1E]">Home</h1>
            <input type="text" placeholder="Search recipe" className="w-full h-[40px] rounded-[8px] px-[16px] py-[8px] border-[2px] border-black  " />
